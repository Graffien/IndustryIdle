export const TR = {
    ...
    AutoSellConcurrency: "Otomatik satılacak kaynak sayısı",
    ...
    BuildingValuation: "İnşaa Değeri ",
    ...
    RatingHold: "Tut",
    RatingOutperform: "Daha iyi değer",
    RatingUnderperform: "Daha kötü değer",
    ...
    OfflineEarningTimeDesc: "Bu zaman zarfında çevrimdışı puan kazanacaksınız",
    BuyPermit: "İzin Satın Al",
    Settings: "Ayarlar",
    Sound: "Ses Efekti",
    SoundDesc: "Tıklama veya hata sesi gibi ses efektini açar",
    MusicDesc: "Müziği açın: Bossa Nova'ya Shane Ivers'tan (https://www.silvermansound.com) kadar değil",
    Credits: "Krediler",
    Icons: "İkonlar",
    MisplacedBuilding: "⛔ Bu %{building}, doğru kaynak depozitinin üstüne yerleştirilmemiş",
    HighlightBuildings: "Bulunan Binalar",
    HighlightTurnedOff: "...bu binaları durdur.",
    HighlightStockpileModeOn: "...stoklama modunu aç",
    HighlightProductionCycleNotDefault: "...üretim döngüsü > 1 olan",
    HighlightMaxInputDistanceNotDefault: "...maksimum giriş mesafesi < ∞",
    HighlightNotMakingProfit: "... karlı değil",
    NBuildingsAreHighlighted: "%{n} bina(lar) bulundu",
    TurnOffProduction: "Üretimi Durdur",
    TurnOffProductionDesc:
        "Binanın üretimini kapatın. Bina artık kaynak üretmeyecek ve güç kullanmayacaktır",
